        ...
        (try_begin)
          ...
          (try_for_range, ':lvar_17', 0, ':lvar_16')
            ...
            (try_begin)
              ...
              (display_log_message, 'str_160', reg20)
            (else_try)
          ...
          (try_for_range, ':lvar_17', 0, ':lvar_16')
            ...
            (display_log_message, 'str_161', reg20)
          (try_end)
          (try_begin)
            (ge, ':lvar_12', 0)
            (party_clear, 1)
          ...
          (try_begin)
            ...
            (display_log_message, 'str_162', reg20)
            (try_begin)
              (eq, '$gvar_269', ':lvar_11')
...
game_get_date_text=>
    ...
    (try_begin)
      (eq, ':lvar_3', 1)
      (str_store_string, 1, 'str_119')
    (else_try)
      (eq, ':lvar_3', 2)
      (str_store_string, 1, 'str_120')
    (else_try)
      (eq, ':lvar_3', 3)
      (str_store_string, 1, 'str_121')
    (else_try)
      (eq, ':lvar_3', 4)
      (str_store_string, 1, 'str_122')
    (else_try)
      (eq, ':lvar_3', 5)
      (str_store_string, 1, 'str_123')
    (else_try)
      (eq, ':lvar_3', 6)
      (str_store_string, 1, 'str_124')
    (else_try)
      (eq, ':lvar_3', 7)
      (str_store_string, 1, 'str_125')
    (else_try)
      (eq, ':lvar_3', 8)
      (str_store_string, 1, 'str_126')
    (else_try)
      (eq, ':lvar_3', 9)
      (str_store_string, 1, 'str_127')
    (else_try)
      (eq, ':lvar_3', 10)
      (str_store_string, 1, 'str_128')
    (try_end)
    (set_result_string, 1)
game_get_money_text=>
    (store_script_param_1, ':lvar_0')
    (try_begin)
      (eq, ':lvar_0', 1)
      (str_store_string, 1, 'str_117')
    (else_try)
      (assign, reg1, ':lvar_0')
      (str_store_string, 1, 'str_118')
    (try_end)
    (set_result_string, 1)
    ...
    (try_for_range, ':lvar_9', 0, 20)
      ...
      (else_try)
        ...
        (try_begin)
          ...
          (assign, ':lvar_11', ':lvar_38')
          (store_random_in_range, ':lvar_18', 'str_281', 'str_285')
          (assign, ':lvar_8', ':lvar_27')
          (assign, ':lvar_23', 500)
          (assign, ':lvar_25', 30)
          (assign, ':lvar_26', 7)
...
let_nearby_parties_join_current_battle=>
    ...
    (try_for_parties, ':lvar_3')
      ...
      (try_begin)
        ...
        (display_message, 'str_142', 16732240)
      (else_try)
        (eq, ':lvar_1', 0)
        (gt, ':lvar_10', 0)
        (lt, ':lvar_11', 0)
        ...
        (str_store_party_name, 1, ':lvar_3')
        (display_message, 'str_143', 5308240)
      (try_end)
    (try_end)
...
create_faction_hero_party=>
    ...
    (party_set_name, '$gvar_590', 'str_12')
...
minorplanet_set_state=>
    ...
    (try_begin)
      (eq, ':lvar_1', 0)
      (party_set_extra_text, ':lvar_0', 'str_1')
...
change_player_relation_with_troop=>
    ...
    (try_begin)
      ...
      (try_begin)
        ...
        (try_begin)
          (gt, ':lvar_1', 0)
          (display_message, 'str_163', 5308240)
        (else_try)
          (lt, ':lvar_1', 0)
          (display_message, 'str_164', 16732240)
        (try_end)
        (try_begin)
          (eq, ':lvar_0', '$gvar_15')
...
change_player_relation_with_faction=>
    ...
    (try_begin)
      (gt, ':lvar_1', 0)
      (display_message, 'str_165', 5308240)
    (else_try)
      (lt, ':lvar_1', 0)
      (display_message, 'str_166', 16732240)
    (try_end)
    (call_script, 283)
...
change_player_party_morale=>
    ...
    (try_begin)
      ...
      (display_message, 'str_168', 16732240)
    (else_try)
      (gt, ':lvar_2', ':lvar_1')
      (store_sub, reg1, ':lvar_2', ':lvar_1')
      (display_message, 'str_167', 5308240)
    (try_end)
    ...
    (try_begin)
      ...
      (try_for_range, ':lvar_2', 1, ':lvar_1')
        ...
        (try_begin)
          ...
          (str_store_string, 51, 'str_11')
        (else_try)
          (str_store_string, 51, 'str_10')
        (try_end)
      (try_end)
      (str_store_string, 2, 'str_182')
    (else_try)
      (eq, ':lvar_1', 1)
      (call_script, 203, ':lvar_0', 0)
      (str_store_party_name_link, 51, reg0)
...
troop_write_family_relations_to_s1=>
    ...
    (try_begin)
      (eq, ':lvar_3', 0)
      (str_store_string, 5, 'str_178')
    (else_try)
      (str_store_string, 5, 'str_179')
    (try_end)
    (try_begin)
      (gt, ':lvar_1', 1)
...
write_family_relation_as_s3s_s2_to_s4=>
    ...
    (try_begin)
      ...
      (try_begin)
        (eq, ':lvar_2', 0)
        (str_store_string, 2, 'str_171')
      (else_try)
        (str_store_string, 2, 'str_172')
      (try_end)
    (else_try)
      ...
      (try_begin)
        (eq, ':lvar_2', 0)
        (str_store_string, 2, 'str_170')
      (else_try)
        (str_store_string, 2, 'str_174')
      (try_end)
    (else_try)
      ...
      (try_begin)
        (eq, ':lvar_2', 0)
        (str_store_string, 2, 'str_175')
      (else_try)
        (str_store_string, 2, 'str_173')
      (try_end)
    (else_try)
      (eq, ':lvar_3', 35)
      (try_begin)
        (eq, ':lvar_2', 0)
        (str_store_string, 2, 'str_176')
      (else_try)
        (str_store_string, 2, 'str_177')
      (try_end)
    (try_end)
    (troop_get_slot, ':lvar_5', ':lvar_0', ':lvar_3')
    (str_store_troop_name_link, 3, ':lvar_5')
    (str_store_string, 4, 'str_180')
...
describe_relation_to_s63=>
    ...
    (store_add, ':lvar_3', 'str_184', ':lvar_2')
...
describe_center_relation_to_s3=>
    ...
    (store_div, ':lvar_2', ':lvar_1', 10)
    (val_clamp, ':lvar_2', 0, 20)
    (store_add, ':lvar_3', 'str_225', ':lvar_2')
...
store_weapon_usage_order_name_to_s1=>
    ...
    (else_try)
      (eq, ':lvar_2', 0)
      (eq, ':lvar_3', 1)
      (str_store_string, 1, 'str_57')
    (else_try)
      (eq, ':lvar_2', 1)
      (eq, ':lvar_3', 1)
      (str_store_string, 1, 'str_58')
    (else_try)
      (str_store_string, 1, '@qstr_295')
    (try_end)
...
start_quest=>
    ...
    (display_message, 'str_364', 6737151)
conclude_quest=>
    (store_script_param, ':lvar_0', 1)
...
update_troop_notes=>
    ...
    (else_try)
      ...
      (try_begin)
        ...
        (store_add, ':lvar_9', 'str_204', ':lvar_8')
        (neq, ':lvar_9', 'str_214')
...
get_name_from_dna_to_s50=>
    (store_script_param, ':lvar_0', 1)
    (store_sub, ':lvar_1', 'str_314', 'str_289')
    (store_sub, ':lvar_2', 'str_355', 'str_314')
    (assign, ':lvar_3', ':lvar_0')
    (val_mod, ':lvar_3', ':lvar_1')
    (assign, ':lvar_4', ':lvar_0')
    (val_div, ':lvar_4', ':lvar_1')
    (val_mod, ':lvar_4', ':lvar_2')
    (val_add, ':lvar_3', 'str_289')
    (val_add, ':lvar_4', 'str_314')
...
initialize_npcs=>
    ...
    (try_for_range, ':lvar_0', 386, 404)
      (try_for_range, ':lvar_1', 0, '$gvar_621')
        ...
        (store_add, ':lvar_4', 'str_408', ':lvar_3')
...
npc_morale=>
    ...
    (try_begin)
      (lt, ':lvar_1', 3)
      (str_store_string, 7, 'str_396')
    (else_try)
      (lt, ':lvar_1', 15)
      (str_store_string, 7, 'str_397')
    (else_try)
      (lt, ':lvar_1', 30)
      (str_store_string, 7, 'str_398')
    (else_try)
      (lt, ':lvar_1', 45)
      (str_store_string, 7, 'str_399')
    (else_try)
      (str_store_string, 7, 'str_400')
    (try_end)
    (try_begin)
      (lt, ':lvar_2', 3)
      (str_store_string, 6, 'str_396')
    (else_try)
      (lt, ':lvar_2', 15)
      (str_store_string, 6, 'str_397')
    (else_try)
      (lt, ':lvar_2', 30)
      (str_store_string, 6, 'str_398')
    (else_try)
      (lt, ':lvar_2', 45)
      (str_store_string, 6, 'str_399')
    (else_try)
      (str_store_string, 6, 'str_400')
    (try_end)
    (try_begin)
      (gt, ':lvar_4', 80)
      (str_store_string, 8, 'str_396')
      (str_store_string, 63, 'str_402')
    (else_try)
      (gt, ':lvar_4', 60)
      (str_store_string, 8, 'str_397')
      (str_store_string, 63, 'str_403')
    (else_try)
      (gt, ':lvar_4', 40)
      (str_store_string, 8, 'str_398')
      (str_store_string, 63, 'str_404')
    (else_try)
      (gt, ':lvar_4', 20)
      (str_store_string, 8, 'str_399')
      (str_store_string, 63, 'str_405')
    (else_try)
      (str_store_string, 8, 'str_400')
      (str_store_string, 63, 'str_406')
    (try_end)
    (str_store_string, 21, 'str_395')
    (assign, reg0, ':lvar_4')
retire_companion=>
    (store_script_param_1, ':lvar_0')
    (store_script_param_2, ':lvar_1')
    ...
    (try_for_range, ':lvar_5', 0, ':lvar_4')
      ...
      (else_try)
        ...
        (try_begin)
          ...
          (gt, ':lvar_11', 0)
          (store_add, ':lvar_12', ':lvar_11', 'str_1299')
...
get_relevant_comment_for_log_entry=>
    ...
    (try_begin)
      ...
      (try_begin)
        (eq, ':lvar_12', 0)
        (gt, '$gvar_281', 0)
        (assign, ':lvar_10', 'str_948')
      (else_try)
        (gt, ':lvar_16', ':lvar_18')
        (assign, ':lvar_10', 'str_949')
        (val_add, ':lvar_10', ':lvar_12')
      (else_try)
        (gt, ':lvar_17', 0)
        (assign, ':lvar_10', 'str_957')
        (val_add, ':lvar_10', ':lvar_12')
      (else_try)
        (assign, ':lvar_10', 'str_965')
        (val_add, ':lvar_10', ':lvar_12')
      (try_end)
    (else_try)
      (eq, ':lvar_1', 1)
      ...
      (try_begin)
        ...
        (assign, ':lvar_9', 200)
        (assign, ':lvar_11', -1)
        (assign, ':lvar_10', 'str_979')
        (try_begin)
          (lt, '$gvar_20', -5)
          (this_or_next|eq, ':lvar_12', 6)
          (eq, ':lvar_12', 7)
          (assign, ':lvar_10', 'str_973')
        (else_try)
          (lt, '$gvar_20', -5)
          (this_or_next|eq, ':lvar_12', 4)
          (eq, ':lvar_12', 3)
          (assign, ':lvar_10', 'str_975')
        (else_try)
          (lt, '$gvar_20', -5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_974')
        (else_try)
          (lt, '$gvar_20', -5)
          (assign, ':lvar_10', 'str_976')
        (else_try)
          (lt, '$gvar_19', -5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_977')
        (else_try)
          (gt, '$gvar_19', 5)
          (assign, ':lvar_10', 'str_978')
        (try_end)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 2)
      ...
      (try_begin)
        ...
        (assign, ':lvar_9', 30)
        (assign, ':lvar_11', -1)
        (assign, ':lvar_10', 'str_984')
        (try_begin)
          (lt, '$gvar_20', -5)
          (this_or_next|eq, ':lvar_12', 4)
          (eq, ':lvar_12', 3)
          (assign, ':lvar_10', 'str_980')
        (else_try)
          (lt, '$gvar_20', -5)
          (assign, ':lvar_10', 'str_981')
        (else_try)
          (gt, '$gvar_19', 5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_982')
        (else_try)
          (gt, '$gvar_19', 5)
          (assign, ':lvar_10', 'str_983')
        (try_end)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 3)
      ...
      (assign, ':lvar_9', 30)
      (assign, ':lvar_11', -1)
      (assign, ':lvar_10', 'str_986')
      (try_begin)
        (lt, '$gvar_20', -5)
        (assign, ':lvar_10', 'str_985')
      (try_end)
    (else_try)
      (eq, ':lvar_1', 4)
      (eq, ':lvar_3', 0)
      (try_begin)
        ...
        (try_begin)
          (this_or_next|eq, ':lvar_12', 6)
          (eq, ':lvar_12', 7)
          (assign, ':lvar_10', 'str_987')
          (assign, ':lvar_11', 1)
        (else_try)
          (gt, '$gvar_19', 5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_988')
          (assign, ':lvar_11', -1)
        (else_try)
          (lt, '$gvar_19', -5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_990')
          (assign, ':lvar_11', -1)
        (else_try)
          (gt, '$gvar_19', 5)
          (assign, ':lvar_10', 'str_989')
        (else_try)
          (this_or_next|eq, ':lvar_12', 3)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_991')
          (assign, ':lvar_11', -1)
        (else_try)
          (assign, ':lvar_10', 'str_992')
        (try_end)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 10)
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_998')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_4', '$gvar_15')
        (this_or_next|eq, ':lvar_12', 1)
        (eq, ':lvar_12', 6)
        (assign, ':lvar_10', 'str_999')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_4', '$gvar_15')
        (assign, ':lvar_10', 'str_1000')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_994')
        (assign, ':lvar_9', 75)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (gt, '$gvar_19', 5)
        (assign, ':lvar_10', 'str_993')
        (assign, ':lvar_9', 75)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_995')
        (assign, ':lvar_9', 75)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (lt, '$gvar_19', -5)
        (assign, ':lvar_10', 'str_996')
        (assign, ':lvar_9', 75)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (assign, ':lvar_10', 'str_997')
        (assign, ':lvar_9', 75)
      (try_end)
    (else_try)
      ...
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1001')
        (assign, ':lvar_9', 150)
      (else_try)
        (lt, '$gvar_19', -5)
        (assign, ':lvar_10', 'str_1002')
        (assign, ':lvar_9', 150)
      (else_try)
        (this_or_next|eq, ':lvar_12', 3)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1003')
        (assign, ':lvar_9', 150)
      (else_try)
        (eq, ':lvar_12', 2)
        (assign, ':lvar_10', 'str_1003')
      ...
      (else_try)
        (eq, ':lvar_12', 7)
        (assign, ':lvar_10', 'str_1005')
        (assign, ':lvar_9', 150)
      (else_try)
        (assign, ':lvar_10', 'str_1006')
        (assign, ':lvar_9', 150)
      (try_end)
    (else_try)
      (this_or_next|eq, ':lvar_1', 10)
      ...
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1007')
        (assign, ':lvar_9', 150)
      (else_try)
        (lt, '$gvar_19', -5)
        (assign, ':lvar_10', 'str_1008')
        (assign, ':lvar_9', 150)
      (else_try)
        (this_or_next|eq, ':lvar_12', 3)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1009')
        (assign, ':lvar_9', 150)
      (else_try)
        (eq, ':lvar_12', 2)
        (assign, ':lvar_10', 'str_1010')
        (assign, ':lvar_9', 150)
      (else_try)
        (eq, ':lvar_12', 7)
        (assign, ':lvar_10', 'str_1011')
        (assign, ':lvar_9', 150)
      (else_try)
        (assign, ':lvar_10', 'str_1012')
        (assign, ':lvar_9', 150)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 19)
      ...
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1013')
        (assign, ':lvar_9', 150)
      (else_try)
        (lt, '$gvar_19', -5)
        (assign, ':lvar_10', 'str_1014')
        (assign, ':lvar_9', 150)
      (else_try)
        (this_or_next|eq, ':lvar_12', 3)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1015')
        (assign, ':lvar_9', 150)
      (else_try)
        (eq, ':lvar_12', 2)
        (assign, ':lvar_10', 'str_1015')
      ...
      (else_try)
        (eq, ':lvar_12', 7)
        (assign, ':lvar_10', 'str_1017')
        (assign, ':lvar_9', 150)
      (else_try)
        (assign, ':lvar_10', 'str_1018')
        (assign, ':lvar_9', 150)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 11)
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 1)
        (eq, ':lvar_12', 6)
        (assign, ':lvar_10', 'str_1024')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (this_or_next|eq, ':lvar_12', 5)
        (eq, ':lvar_12', 2)
        (assign, ':lvar_10', 'str_1025')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (assign, ':lvar_10', 'str_1026')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_7', '$gvar_18')
        (this_or_next|eq, ':lvar_12', 7)
        (eq, ':lvar_12', 4)
        (assign, ':lvar_10', 'str_1066')
        (assign, ':lvar_9', 85)
      (else_try)
        (eq, ':lvar_7', '$gvar_18')
        (this_or_next|eq, ':lvar_12', 1)
        (eq, ':lvar_12', 6)
        (assign, ':lvar_10', 'str_1067')
        (assign, ':lvar_9', 85)
      (else_try)
        (eq, ':lvar_7', '$gvar_18')
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1068')
        (assign, ':lvar_9', 85)
      (else_try)
        (eq, ':lvar_7', '$gvar_18')
        (assign, ':lvar_10', 'str_1069')
        (assign, ':lvar_9', 85)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (faction_slot_eq, '$gvar_281', 10, '$gvar_15')
        (assign, ':lvar_10', 'str_1019')
        (assign, ':lvar_9', 70)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
      ...
      (else_try)
        ...
        (this_or_next|eq, ':lvar_12', 7)
        (eq, ':lvar_12', 1)
        (assign, ':lvar_10', 'str_1022')
        (assign, ':lvar_9', 65)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (assign, ':lvar_10', 'str_1023')
        (assign, ':lvar_9', 65)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 11)
    ...
    (else_try)
      ...
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 7)
        (eq, ':lvar_12', 1)
        (assign, ':lvar_10', 'str_1043')
        (assign, ':lvar_9', 65)
        (assign, ':lvar_11', 2)
      (else_try)
        (lt, '$gvar_19', -5)
        (assign, ':lvar_10', 'str_1044')
        (assign, ':lvar_9', 0)
      (else_try)
        (eq, ':lvar_12', 0)
        (assign, ':lvar_10', 'str_1045')
        (assign, ':lvar_9', 65)
        (assign, ':lvar_11', 3)
      (else_try)
        (lt, '$gvar_19', -5)
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1046')
        (assign, ':lvar_9', 65)
      (else_try)
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1047')
        (assign, ':lvar_9', 65)
      (else_try)
        (this_or_next|eq, ':lvar_12', 1)
        (eq, ':lvar_12', 7)
        (assign, ':lvar_10', 'str_1048')
        (assign, ':lvar_9', 65)
        (assign, ':lvar_11', 2)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (assign, ':lvar_10', 'str_1049')
      (try_end)
    (else_try)
      (eq, ':lvar_1', 14)
      (troop_slot_eq, '$gvar_15', 19, ':lvar_0')
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1032')
        (assign, ':lvar_9', 150)
      (else_try)
        (lt, '$gvar_19', -5)
        (assign, ':lvar_10', 'str_1033')
        (assign, ':lvar_9', 150)
      (else_try)
        (this_or_next|eq, ':lvar_12', 3)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1034')
        (assign, ':lvar_9', 150)
      (else_try)
        (assign, ':lvar_10', 'str_1035')
        (assign, ':lvar_9', 150)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 14)
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1027')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (eq, ':lvar_12', 1)
        (assign, ':lvar_10', 'str_1028')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (this_or_next|eq, ':lvar_12', 6)
        (eq, ':lvar_12', 7)
        (assign, ':lvar_10', 'str_1029')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (this_or_next|eq, ':lvar_12', 3)
        (eq, ':lvar_12', 4)
        (assign, ':lvar_10', 'str_1030')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (assign, ':lvar_10', 'str_1031')
        (assign, ':lvar_9', 200)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (assign, ':lvar_10', 'str_1031')
      ...
      (else_try)
        ...
        (eq, ':lvar_12', 5)
        (le, '$gvar_19', 5)
        (assign, ':lvar_10', 'str_1038')
        (assign, ':lvar_9', 80)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (eq, ':lvar_12', 3)
        (assign, ':lvar_10', 'str_1039')
        (assign, ':lvar_9', 65)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (eq, ':lvar_12', 7)
        (lt, '$gvar_19', -15)
        (assign, ':lvar_10', 'str_1040')
        (assign, ':lvar_9', 65)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, '$gvar_19', -10)
        (assign, ':lvar_10', 'str_1041')
        (assign, ':lvar_9', 65)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (assign, ':lvar_10', 'str_1042')
        (assign, ':lvar_9', 65)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 15)
      ...
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1052')
        (assign, ':lvar_9', 150)
        (assign, ':lvar_11', -5)
      (else_try)
        (lt, '$gvar_19', -5)
        (eq, ':lvar_12', 3)
        (assign, ':lvar_10', 'str_1053')
        (assign, ':lvar_9', 150)
        (assign, ':lvar_11', -5)
      (else_try)
        (lt, '$gvar_19', -5)
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1054')
        (assign, ':lvar_11', -5)
      (else_try)
        (eq, ':lvar_12', 1)
        (assign, ':lvar_10', 'str_1055')
        (assign, ':lvar_9', 150)
        (assign, ':lvar_11', -2)
      (else_try)
        (this_or_next|eq, ':lvar_12', 7)
        (eq, ':lvar_12', 6)
        (assign, ':lvar_10', 'str_1056')
        (assign, ':lvar_9', 150)
        (assign, ':lvar_11', -1)
      (else_try)
        (assign, ':lvar_10', 'str_1057')
        (assign, ':lvar_9', 150)
        (assign, ':lvar_11', -2)
      (try_end)
    (else_try)
      ...
      (try_begin)
        (this_or_next|eq, ':lvar_12', 3)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1058')
        (assign, ':lvar_9', 25)
      (else_try)
        (eq, ':lvar_12', 1)
        (assign, ':lvar_10', 'str_1059')
        (assign, ':lvar_9', 25)
      (else_try)
        (this_or_next|eq, ':lvar_12', 6)
        (eq, ':lvar_12', 7)
        (assign, ':lvar_10', 'str_1060')
        (assign, ':lvar_9', 25)
      (else_try)
        (eq, ':lvar_12', 4)
        (assign, ':lvar_10', 'str_1061')
        (assign, ':lvar_9', 25)
      (else_try)
        (assign, ':lvar_10', 'str_1062')
        (assign, ':lvar_9', 25)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 16)
    ...
    (else_try)
      ...
      (try_begin)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1079')
        (assign, ':lvar_9', 300)
        (assign, ':lvar_11', -15)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (ge, '$gvar_20', 0)
        (assign, ':lvar_10', 'str_1083')
        (assign, ':lvar_9', 300)
        (assign, ':lvar_11', 2)
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
      ...
      (else_try)
        ...
        (eq, ':lvar_12', 4)
        (assign, ':lvar_9', 300)
        (assign, ':lvar_10', 'str_1081')
      (else_try)
        (eq, ':lvar_6', '$gvar_15')
        (lt, '$gvar_20', 0)
        (assign, ':lvar_9', 300)
        (assign, ':lvar_10', 'str_1082')
        (assign, ':lvar_11', 1)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
      ...
      (else_try)
        ...
        (this_or_next|eq, ':lvar_12', 2)
        (eq, ':lvar_12', 5)
        (assign, ':lvar_10', 'str_1077')
        (assign, ':lvar_9', 80)
      (else_try)
        (eq, '$gvar_281', '$gvar_18')
        (lt, ':lvar_15', 0)
        (neq, ':lvar_6', '$gvar_15')
        (assign, ':lvar_10', 'str_1078')
        (assign, ':lvar_9', 80)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 21)
      ...
      (try_begin)
        ...
        (try_begin)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 1)
          (assign, ':lvar_10', 'str_1084')
        (else_try)
          (eq, ':lvar_12', 1)
          (assign, ':lvar_10', 'str_1085')
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 2)
          (assign, ':lvar_10', 'str_1086')
        (else_try)
          (eq, ':lvar_12', 2)
          (assign, ':lvar_10', 'str_1087')
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 3)
          (assign, ':lvar_10', 'str_1088')
        (else_try)
          (eq, ':lvar_12', 3)
          (assign, ':lvar_10', 'str_1089')
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 4)
          (assign, ':lvar_10', 'str_1090')
        (else_try)
          (eq, ':lvar_12', 4)
          (assign, ':lvar_10', 'str_1091')
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_1092')
        (else_try)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_1093')
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 6)
          (assign, ':lvar_10', 'str_1094')
        (else_try)
          (eq, ':lvar_12', 6)
          (assign, ':lvar_10', 'str_1095')
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 7)
          (assign, ':lvar_10', 'str_1096')
        (else_try)
          (eq, ':lvar_12', 7)
          (assign, ':lvar_10', 'str_1097')
        (try_end)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 22)
      ...
      (try_begin)
        ...
        (try_begin)
          ...
          (this_or_next|eq, ':lvar_12', 3)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_1098')
        (else_try)
          (gt, '$gvar_19', 5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 4)
          (assign, ':lvar_10', 'str_1099')
        (else_try)
          (gt, '$gvar_19', 5)
          (assign, ':lvar_10', 'str_1100')
        (else_try)
          (is_between, '$gvar_19', -5, 5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_1103')
          (assign, ':lvar_11', -2)
        (else_try)
          (lt, '$gvar_19', -5)
          (eq, ':lvar_12', 7)
          (assign, ':lvar_10', 'str_1101')
        (else_try)
          (lt, '$gvar_19', -5)
          (this_or_next|eq, ':lvar_12', 2)
          (eq, ':lvar_12', 5)
          (assign, ':lvar_10', 'str_1102')
        (else_try)
          (assign, ':lvar_10', 'str_1104')
        (try_end)
      (try_end)
    (else_try)
      (eq, ':lvar_1', 23)
      ...
      (try_begin)
        ...
        (else_try)
          ...
          (try_begin)
            ...
            (this_or_next|eq, ':lvar_12', 3)
            (eq, ':lvar_12', 5)
            (assign, ':lvar_10', 'str_1108')
          (else_try)
            (gt, '$gvar_19', 5)
            (this_or_next|eq, ':lvar_12', 6)
            (eq, ':lvar_12', 7)
            (assign, ':lvar_10', 'str_1105')
          (else_try)
            (gt, '$gvar_19', 5)
            (assign, ':lvar_10', 'str_1109')
          (else_try)
            (is_between, '$gvar_19', -5, 5)
            (this_or_next|eq, ':lvar_12', 2)
            (eq, ':lvar_12', 5)
            (assign, ':lvar_10', 'str_1107')
            (assign, ':lvar_11', -2)
          (else_try)
            (lt, '$gvar_19', -5)
            (this_or_next|eq, ':lvar_12', 2)
...
get_relevant_comment_to_s42=>
    ...
    (try_begin)
      (eq, '$gvar_152', 1)
      (store_add, ':lvar_1', ':lvar_0', 'str_1111')
...
print_wpn_upgrades_to_s0=>
    ...
    (else_try)
      (str_store_string, 10, 'str_1383')
    (try_end)
    (val_add, ':lvar_1', 'str_1393')
...
setup_spaceship_slots=>
    (party_set_slot, 249, 250, 'str_1500')
    (party_set_slot, 249, 251, 17000)
    (party_set_slot, 249, 252, 'str_1501')
    ...
    (party_set_slot, 250, 250, 'str_1502')
    (party_set_slot, 250, 251, 30000)
    (party_set_slot, 250, 252, 'str_1503')
    ...
    (party_set_slot, 251, 250, 'str_1498')
    (party_set_slot, 251, 251, 48000)
    (party_set_slot, 251, 252, 'str_1499')
    ...
    (party_set_slot, 252, 250, 'str_1494')
    (party_set_slot, 252, 251, 60000)
    (party_set_slot, 252, 252, 'str_1495')
    ...
    (party_set_slot, 253, 250, 'str_1496')
    (party_set_slot, 253, 251, 90000)
    (party_set_slot, 253, 252, 'str_1497')
    ...
    (party_set_slot, 254, 250, 'str_1490')
    (party_set_slot, 254, 251, 170000)
    (party_set_slot, 254, 252, 'str_1491')
    ...
    (party_set_slot, 255, 250, 'str_1492')
    (party_set_slot, 255, 251, 150000)
    (party_set_slot, 255, 252, 'str_1493')
    ...
    (party_set_slot, 256, 250, 'str_1504')
    (party_set_slot, 256, 251, 25500)
    (party_set_slot, 256, 252, 'str_1505')
    ...
    (party_set_slot, 257, 250, 'str_1514')
    (party_set_slot, 257, 251, 19800)
    (party_set_slot, 257, 252, 'str_1515')
    ...
    (party_set_slot, 258, 250, 'str_1516')
    (party_set_slot, 258, 251, 27000)
    (party_set_slot, 258, 252, 'str_1517')
    ...
    (party_set_slot, 261, 250, 'str_1510')
    (party_set_slot, 261, 251, 84000)
    (party_set_slot, 261, 252, 'str_1511')
    ...
    (party_set_slot, 262, 250, 'str_1512')
    (party_set_slot, 262, 251, 54000)
    (party_set_slot, 262, 252, 'str_1513')
    ...
    (party_set_slot, 260, 250, 'str_1506')
    (party_set_slot, 260, 251, 70000)
    (party_set_slot, 260, 252, 'str_1507')
    ...
    (party_set_slot, 259, 250, 'str_1508')
    (party_set_slot, 259, 251, 96000)
    (party_set_slot, 259, 252, 'str_1509')
    ...
    (party_set_slot, 263, 250, 'str_1526')
    (party_set_slot, 263, 251, 21000)
    (party_set_slot, 263, 252, 'str_1527')
    ...
    (party_set_slot, 264, 250, 'str_1524')
    (party_set_slot, 264, 251, 42000)
    (party_set_slot, 264, 252, 'str_1525')
    ...
    (party_set_slot, 265, 250, 'str_1520')
    (party_set_slot, 265, 251, 45000)
    (party_set_slot, 265, 252, 'str_1521')
    ...
    (party_set_slot, 266, 250, 'str_1522')
    (party_set_slot, 266, 251, 60000)
    (party_set_slot, 266, 252, 'str_1523')
    ...
    (party_set_slot, 267, 250, 'str_1518')
    (party_set_slot, 267, 251, 67500)
    (party_set_slot, 267, 252, 'str_1519')
    ...
    (party_set_slot, 272, 250, 'str_1540')
    (party_set_slot, 272, 251, 10500)
    (party_set_slot, 272, 252, 'str_1541')
    ...
    (party_set_slot, 273, 250, 'str_1542')
    (party_set_slot, 273, 251, 30000)
    (party_set_slot, 273, 252, 'str_1543')
    ...
    (party_set_slot, 268, 250, 'str_1528')
    (party_set_slot, 268, 251, 18000)
    (party_set_slot, 268, 252, 'str_1529')
    ...
    (party_set_slot, 271, 250, 'str_1530')
    (party_set_slot, 271, 251, 16500)
    (party_set_slot, 271, 252, 'str_1531')
    ...
    (party_set_slot, 274, 250, 'str_1538')
    (party_set_slot, 274, 251, 12000)
    (party_set_slot, 274, 252, 'str_1539')
    ...
    (party_set_slot, 275, 250, 'str_1536')
    (party_set_slot, 275, 251, 13000)
    (party_set_slot, 275, 252, 'str_1537')
    ...
    (party_set_slot, 276, 250, 'str_1532')
    (party_set_slot, 276, 251, 16000)
    (party_set_slot, 276, 252, 'str_1533')
    ...
    (party_set_slot, 277, 250, 'str_1534')
    (party_set_slot, 277, 251, 27000)
    (party_set_slot, 277, 252, 'str_1535')
    ...
    (party_set_slot, 278, 250, 'str_1544')
    (party_set_slot, 278, 251, 31500)
    (party_set_slot, 278, 252, 'str_1545')
    ...
    (party_set_slot, 279, 250, 'str_1546')
    (party_set_slot, 279, 251, 200000)
    (party_set_slot, 279, 252, 'str_1547')
    ...
    (party_set_slot, 270, 250, 'str_1548')
    (party_set_slot, 270, 251, 95000)
    (party_set_slot, 270, 252, 'str_1549')
    ...
    (party_set_slot, 269, 250, 'str_1550')
    (party_set_slot, 269, 251, 17000)
    (party_set_slot, 269, 252, 'str_1551')
